            ...
            <div class="col-md-12">
                <div class="panel rounded shadow">
                    <div class="panel-heading">
                        <h3 class="panel-title">Unavailable Rooms</h3>
                    </div><!-- /.panel-heading -->
   ...
   <div class="panel-body no-padding">
       <div>
            ...
            <br>
                <div class="table-responsive">
                    <table class="table table-bordered table-middle table-lilac">
                        ...
                        <tbody>
                            <?php if (!empty($not_available_rooms)){ ?>
                            <?php $count = 1; foreach ($not_available_rooms as $key): ?>
                            ...
                            <tr class="border-warning">
                                ...
                                <td>
                                 ...
                                 <!-- <td class="text-center">
                                    <a  data-target="#<?php echo $key->roomid; ?>" class="btn btn-success btn-xs " data-toggle="modal"><b> <i  data-toggle="tooltip" data-placement="top" title="Reserve" class="fa fa-thumbs-up"></i> </b></a> 
                                </td> -->
                                </tr>
        ...
        <!--/ END BACK TOP -->
                ...
                <?php foreach ($not_available_rooms as $key): ?>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <h4>Update Room <b><?php   echo ($key->room_number);?></b> to occupied  ?</h4>
                                    </div>
                                    <div class="modal-footer">
                                        ...
                                        <a href="<?php echo base_url("main/do_unreserve/$key->roomid");?>" class="btn btn-info"><span class="glyphicon glyphicon-plus"></span> Yes</a>
                                    </div>
                                </div>
                            </div>
                        </div>
