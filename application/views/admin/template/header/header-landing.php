<!DOCTYPE html>
    ...
    <head>
        ...
        <link href="<?php echo base_url('assets/css13b7.css?family=Open+Sans:400,300,600,700');?>" rel="stylesheet">
        <link href="<?php echo base_url('assets/css6a78.css?family=Oswald:700,400');?>" rel="stylesheet">
        ...
        <link href="<?php echo base_url('assets/fontawesome/font-awesome-4.5.0/css/font-awesome.min.css');?>" rel="stylesheet" />
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/assets/TooltipMenu/css/default.css');?>" />
        <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/assets/TooltipMenu/css/component.css');?>" />
...
<!-- css for data-tables 
 ...
 -->        
    ...
    <body class="page-footer-fixed page-header-fixed">
        <section id="wrapper">
